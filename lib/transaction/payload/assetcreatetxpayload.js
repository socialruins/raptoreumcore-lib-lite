...
*/
    ...
    payload.referenceHash = payloadBufferReader.read(Buffer.from(this.referenceHash, "utf8").length).toString();
    ...
    payload.scriptTargetAddress = payloadBufferReader.read(constants.PUBKEY_ID_SIZE).toString('hex');
    ...
    payload.scriptOwnerAddress = payloadBufferReader.read(constants.PUBKEY_ID_SIZE).toString('hex');
    payload.collateralAddress = payloadBufferReader.readUInt8();
    payload.exChainType = payloadBufferReader.readUInt16LE();
    payload.externalPayoutAddress = payloadBufferReader.read(constants.PUBKEY_ID_SIZE).toString('hex');
