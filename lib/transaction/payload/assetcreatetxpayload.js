...
*/
    ...
    payload.externalPayoutAddress = payloadBufferReader.readVarintNum();
...
*/
    ...
    payloadBufferWriter.writeVarintNum(constants.PUBKEY_ID_SIZE); //externalPayoutAddress not used
