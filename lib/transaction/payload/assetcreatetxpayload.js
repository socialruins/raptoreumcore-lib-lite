...
*/
    ...
    if (options) {
        ...
        this.isUnique = options.isUnique === 1 ? true : false;
        this.maxMintCount = options.maxMintCount;
        this.updatable = options.updatable === 1 ? true : false;
...
*/
    ...
    //var assetName = payloadBufferReader.readVarintNum(128);
    payload.name = payloadBufferReader.read(128).toString();
    ...
    payload.referenceHash = payloadBufferReader.read(128).toString();
...
*/
    ...
    //var assetName = Buffer.from(this.name, 'utf-8');
    payloadBufferWriter.writeVarintNum(128);
    payloadBufferWriter.write(this.name);
    ...
    //var referenceHash = Buffer.from(this.referenceHash, 'utf-8');
    payloadBufferWriter.writeVarintNum(128);
    payloadBufferWriter.write(this.referenceHash);
