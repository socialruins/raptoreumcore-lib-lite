...
*/
    ...
    payload.amount = payloadBufferReader.readUInt64LEBN();
...
*/
    ...
    var assetName = Buffer.from(this.name, "utf8").toString('hex');
    ...
    var referenceHash = Buffer.from(this.referenceHash, "utf8").toString('hex');
    ...
    payloadBufferWriter.writeUInt64LEBN(this.amount);
