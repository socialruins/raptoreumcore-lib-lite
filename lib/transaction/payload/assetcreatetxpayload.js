...
*/
    ...
    var scriptExternalPayoutAddressSize = payloadBufferReader.readVarintNum();
    payload.externalPayoutAddress = payloadBufferReader.read(scriptExternalPayoutAddressSize).toString('hex');
...
*/
    ...
    var scriptExternalPayoutAddress = Buffer.from(this.externalPayoutAddress, 'hex');
    payloadBufferWriter.writeVarintNum(scriptExternalPayoutAddress.length);
    payloadBufferWriter.write(scriptExternalPayoutAddress); //externalPayoutAddress not used
